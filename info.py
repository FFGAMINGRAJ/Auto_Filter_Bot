...
PICS_URL = (environ.get('PICS', 'https://i.ibb.co/JRxwSZvs/x.jpg')).split() #random anime girl img each time from aniwallpaper (Experimental)
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8552470289').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003586233952').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003477267827'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003426123991'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003287169012'))  # Premium logs channel id
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+6JOcwOhL46U2NjM1')  # Support group link (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1003335865847 -1003361913043")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/kgrwDqTZ/x.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'mikeykunraj@fam')    # Owner UPI ID for payments
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003361913043'))  # Notification of sent to your channel
...
TMDB_API_KEY = environ.get('TMDB_API_KEY', '64ac243c746e85ce73137ab9a1c0f095') # preffer to use your own tmdb API Key get it from https://www.themoviedb.org/settings/api
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003461533973')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003471860483')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/Anime_Verify_Tutorials")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/Anime_Verify_Tutorials")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/Anime_Verify_Tutorials")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Shadow_Hindi_Movies') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Rz_Anime_Group') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+bsUOyWoWles0ZmJl') # Update channel link for the bot
