...
PICS_URL = (environ.get('PICS', 'https://i.ibb.co/NdJqSv4t/x.jpg')).split() #random anime girl img each time from aniwallpaper (Experimental)
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003256948624').split()]  # Channel id for auto indexing (make sure bot is admin)
